...
// originally ported from https://github.com/3mcd/javelin/blob/master/packages/hrtime-loop/src/index.ts

export interface HighResolutionLoop {
  /**
 ...
 * @returns
 */
export function createHighResolutionLoop(
